...
import os
import sys
# print(os.path.join(os.path.dirname(os.getcwd()),"RAKE"))
# --RAKE
#   --rake.py
# --KPEGCN
#   --utils
sys.path.insert(0,os.path.join(os.path.dirname(os.getcwd()),"RAKE"))
import rake
...
def listcut(tuple_list, start, end):
    tuple_list = tuple_list[start:end]
    D = dict(tuple_list)
    return D